...
public class EntrindenVonHand extends Motormanuell {
	...
	private ModelMotormanuellEntrindenVonHand model = new ModelMotormanuellEntrindenVonHand();
	
	
	public EntrindenVonHand() {
		super.setTitle("Entrinden von Hand");
...
//		c.insets = new Insets(5,5,5,5);
	...
	@Override
	public ModelMotormanuellEntrindenVonHand getModel() {
		return (ModelMotormanuellEntrindenVonHand) model;
	}
	...
	protected void initData() {
		panelKostensaetze.setLabelMaschine("Schäleisen");
	}
