...
import ch.wsl.fps.hepromo.gui.modelle.panel.aobj.BestandPanelEntrinden;
...
public class EntrindenMitBiber extends Motormanuell{

	private static final long serialVersionUID = 1L;
	
	private BestandPanelEntrinden panelBestand;
	private GelaendePanel panelGelaende;
	
	private ModelMotormanuellEntrindenMitBiber model = new ModelMotormanuellEntrindenMitBiber();
	
	
	public EntrindenMitBiber() {
		super.setTitle("Entrinden mit Biber");
...
//		c.insets = new Insets(5,5,5,5);
		panelBestand = new BestandPanelEntrinden(this);
...
//		c.insets = new Insets(5,5,5,5);
	...
	public void loadGUIToModel() {
		...
		model.getArbeitsobjekt().setAnteilShUndIhLang(		panelBestand.getAnteilShUndIhLang()		);
	}


	@Override
	public ModelMotormanuellEntrindenMitBiber getModel() {
		return (ModelMotormanuellEntrindenMitBiber) model;
	}
	...
	public void loadModelToGUI(HeProMoInputData data) {
		...
		panelBestand.setAnteilShUndIhLang(	 	((ArbeitsobjektEntrinden) data.getArbeitsobjekt()).getAnteilShUndIhLang()		);	
	...
	protected void initData() {
		panelKostensaetze.setLabelMaschine("Biber");
	}
