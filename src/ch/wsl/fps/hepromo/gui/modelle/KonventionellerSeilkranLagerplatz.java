...
public class KonventionellerSeilkranLagerplatz extends SeilkranLagerplatz {

	private static final long serialVersionUID = 1L;

	public KonventionellerSeilkranLagerplatz() {
		super(new ModelKonventionellerSeilkranLagerplatz());
	}
