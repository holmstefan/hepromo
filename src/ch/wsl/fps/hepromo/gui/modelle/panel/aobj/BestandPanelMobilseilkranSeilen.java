...
public class BestandPanelMobilseilkranSeilen extends JPanel {
	...
	private void initPanel() {
		this.setBorder(BorderFactory.createTitledBorder(GuiStrings.getString("BestandPanelMobilseilkranSeilen.Title")));		 //$NON-NLS-1$
...
//		c.insets = new Insets(5,5,5,5);
	...
	private void initData(){
		...
		txtNutzungsmenge_m3iR.addChangeListener(new ChangeListener() {
			@Override
