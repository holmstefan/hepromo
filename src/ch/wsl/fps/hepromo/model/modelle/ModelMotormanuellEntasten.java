 ...
 *
 */
public class ModelMotormanuellEntasten extends AbstractModel {

	/**
	 * Constructor
	 */
	public ModelMotormanuellEntasten() {
		super.arbeitsobjekt = new ArbeitsobjektEntastenMotormanuell();
		...
		super.calculator = new CalculatorEntastenMotormanuell(this);
	}
	 ...
	 * Constructor
	 */
	public ModelMotormanuellEntasten(HeProMoInputData inputData) {
		this();
		if (inputData != null) {
	...
	@Override
	public ArbeitsobjektEntastenMotormanuell getArbeitsobjekt() {
		return (ArbeitsobjektEntastenMotormanuell) arbeitsobjekt;
	}


	@Override
	protected String getModelName() {
		return "Motormanuell: Entasten";
	}
