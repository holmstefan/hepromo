 ...
 *
 */
public class ModelMotormanuellFaellen extends AbstractModel {

	/**
	 * Constructor
	 */
	public ModelMotormanuellFaellen() {
		super.arbeitsobjekt = new ArbeitsobjektFaellenMotormanuell();
		...
		getArbeitsobjekt().setAnteilFaellenHandseilzug_Prz(0);
		...
		super.calculator = new CalculatorFaellenMotormanuell(this);
	}
	 ...
	 * Constructor
	 */
	public ModelMotormanuellFaellen(HeProMoInputData inputData) {
		this();
		if (inputData != null) {
	...
	@Override
	public ArbeitsobjektFaellenMotormanuell getArbeitsobjekt() {
		return (ArbeitsobjektFaellenMotormanuell) arbeitsobjekt;
	}


	@Override
	protected String getModelName() {
		return "Motormanuell: Fällen";
	}
