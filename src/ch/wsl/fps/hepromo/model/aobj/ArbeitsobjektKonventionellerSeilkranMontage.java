 ...
 *
 */
public class ArbeitsobjektKonventionellerSeilkranMontage extends ArbeitsobjektKonventionellerSeilkranMontageDemontage {
	...
	public LabelValuePairList getLabelValuePairList(DecimalFormat decimalFormat) {
		...
		list.add("Montage ist Seilverlegung", montageIstSeilverlegung);
