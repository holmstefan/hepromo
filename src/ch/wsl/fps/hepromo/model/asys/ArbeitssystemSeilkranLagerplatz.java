 ...
 *
 */
public class ArbeitssystemSeilkranLagerplatz extends Arbeitssystem {
	
	private static final long serialVersionUID = 1L;
	
	private int anzahlPersonal;
	private int einsatzzeitPersonal_Prz;
	...
	public int getEinsatzzeitPersonal_Prz() {
		return einsatzzeitPersonal_Prz;
	}
	
	
	public void setEinsatzzeitPersonal_Prz(int einsatzzeitPersonal_Prz) {
		this.einsatzzeitPersonal_Prz = einsatzzeitPersonal_Prz;
	}
	...
	public LabelValuePairList getLabelValuePairList(DecimalFormat decimalFormat, String waehrung) {
		...
		list.add("Einsatzzeit Personal (%)", einsatzzeitPersonal_Prz);
		list.add("Laufzeit Kranfahrzeug (%)", laufzeitKranfahrzeug_Prz);
