 ...
 */
@Test
public class ModelMobilseilkranSeilenTest extends AbstractModelTest {

	@Override
	protected String getCsvPath() {
		return "testcases/MobilseilkranSeilen.csv";
	}

	@Override
	protected AbstractModel getModel(HeProMoInputData inputData) {
		return new ModelMobilseilkranSeilen(inputData);
	}
	...
	protected Arbeitsobjekt parseArbeitsobjektData(String[] testcase) {
		...
		ao.setMittlereFahrdistanz_m(			Integer.valueOf(testcase[4]));
		ao.setMittlereDistanzSeitlicherZuzug_m(	Integer.valueOf(testcase[5]));
		ao.setSchwierigkeitSeitlicherZuzug(		SchwierigkeitSeitlicherZuzug.valueOf(testcase[6]));
		return ao;
	}
	...
	protected Arbeitssystem parseArbeitssystemData(String[] testcase) {
		...
		as.setAnzahlPersonal(				Integer.valueOf(testcase[8]));
		as.setKostensatzMaschine1_proH(			Double.valueOf(testcase[9]));
		as.setAnteilSeilkranLaufzeit_Prz(	Integer.valueOf(testcase[10]));
