 ...
 */
@Test
public class ModelMotormanuellFaellenTest extends AbstractModelTest {

	@Override
	protected String getCsvPath() {
		return "testcases/FaellenMotormanuell.csv";
	}
	...
	protected Arbeitsobjekt parseArbeitsobjektData(String[] testcase) {
		...
		ao.setAnteilFaellenHandseilzug_Prz(Double.valueOf(testcase[3]));
	...
	protected AbstractModel getModel(HeProMoInputData inputData) {
		return new ModelMotormanuellFaellen(inputData);
	}
